...
A shell script __FOR LINUX__ that analyzes the file size distribution within a given directory to provide an intelligent ZFS `recordsize` recommendation. It helps you make an informed decision by visualizing the data and understanding the trade-offs between different record sizes for your specific workload.  
