...
# Estimate max files via inode count (conservative).
# Falls back to find | wc -l for dynamic-inode filesystems (Btrfs).
...
END {
    ...
    print  "      VMs (ext4/NTFS) .... 4k-16k   BitTorrent .......... 16k";
    ...
    printf "\n%s%s\n", C_RESET, DSEP;
    print "NOTE: These are suggestions based on file size distribution. Always benchmark your specific workload.";
}
'
